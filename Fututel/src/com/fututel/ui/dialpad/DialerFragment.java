...
package com.fututel.ui.dialpad;
...
import com.fututel.api.*;
import com.fututel.db.DBProvider;
import com.fututel.ui.SipHome;
import com.fututel.ui.SipHome.ViewPagerVisibilityListener;
import com.fututel.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
import com.fututel.utils.*;
import com.fututel.utils.CallHandlerPlugin.OnLoadListener;
import com.fututel.utils.contacts.ContactsSearchAdapter;
import com.fututel.widgets.AccountChooserButton;
import com.fututel.widgets.AccountChooserButton.OnAccountChangeListener;
import com.fututel.widgets.DialerCallBar;
import com.fututel.widgets.DialerCallBar.OnDialActionListener;
import com.fututel.widgets.Dialpad;
import com.fututel.widgets.Dialpad.OnDialKeyListener;
...
public class DialerFragment extends SherlockFragment implements OnClickListener, OnLongClickListener,
    ...
    */
    ...
    private JsonHttpResponseHandler handler1 = null;
    private static TextView username;
    private static ImageView status_img;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        */
        ...
        v.findViewById(R.id.deleteButton).setOnLongClickListener(this);
    ...
    public void onResume() {
        ...
        if (prefs.getBoolean("registered", false) == true)
        {
            //rangdong
            edit.putBoolean("registered", true);
            username.setText("Registered");//rangdong
            status_img.setImageResource(R.drawable.active_img);
        }
        else
        {
            edit.putBoolean("registered", false);
            username.setText("");//rangdong
            status_img.setImageResource(R.drawable.inactive_img);
        }
    ...
    public void RunBackGround1( String userid)
    {
        handler_progress1();
        ...
        try {
            EvalData.put("act", "balance");
            JSONObject jsonjsondata = new JSONObject();
            jsonjsondata.put("userId", userid);
            EvalData.put("fields",jsonjsondata);
        ...
        client.get("http://speedycall.net/en/api/ajax.htm?jsonData=" + URLEncoder.encode(EvalData.toString()), handler1);
    }


    private void handler_progress1()
    {
        handler1 = new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(JSONObject jsonData) {
                ...
                try {
                    ...
                    if (status.equals("ok"))
                    {
                        result = jsonData.getString("text");
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        delMenu.setVisible(false);//rangdong
    }
    ...
    private void placeCallWithOption(Bundle b) {
        ...
        toCall = toCall.replace("+", ""); //rangdong
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), com.fututel.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
    ...
    public  static void registerCheck(Context context)
    {
