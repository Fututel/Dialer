...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = "com.fututel.service.SipConfiguration";
    /**
     ...
     */
    public static final String INTENT_SIP_SERVICE = "com.fututel.service.SipService";
     ...
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = "com.fututel.accounts.activate";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_UI = "com.fututel.phone.action.INCALL";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = "com.fututel.phone.action.DIALER";
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = "com.fututel.phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = "com.fututel.phone.action.MESSAGES";
    public static final String ACTION_SIP_CHAT = "com.ringplus.ui.action.PREFS_CHAT";

    /**
     * Action launched when user want to go in sip favorites.
     * Should raise the sip favorites view.
     */
    public static final String ACTION_SIP_FAVORITES = "com.fututel.phone.action.FAVORITES";
    /**
     ...
     */
    public static final String ACTION_UI_PREFS_GLOBAL = "com.fututel.ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = "com.fututel.service.CALL_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "com.fututel.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = "com.fututel.service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = "com.fututel.service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = "com.fututel.service.SHOW_SAS";
    /**
     ...
     */
    public static final String ACTION_SIP_MESSAGE_RECEIVED = "com.fututel.service.MESSAGE_RECEIVED";
    /**
     * Broadcast sent when a conversation has been recorded.<br/>
     * This is linked to the call record feature of Fututel available through {@link ISipService#startRecording(int)}
     * <p>
     * Provided extras :
     * <ul>
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = "com.fututel.service.CALL_RECORDED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = "com.fututel.service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "com.fututel.service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = "com.fututel.service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = "com.fututel.service.ACTION_DEFER_OUTGOING_UNREGISTER";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = "com.fututel.themes.GET_DRAWABLES";
    /**
     ...
     * </ul>
     */
    public static final String ACTION_GET_PHONE_HANDLERS = "com.fututel.phone.action.HANDLE_CALL";
     ...
     */
    public static final String ACTION_INCALL_PLUGIN = "com.fututel.sipcall.action.HANDLE_CALL_PLUGIN";
    
    public static final String EXTRA_SIP_CALL_MIN_STATE = "com.fututel.sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = "com.fututel.sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = "com.fututel.sipcall.CALL_WAY";
     ...
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = "com.fututel.phone.action.REWRITE_NUMBER";
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = "com.fututel.codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video codec.
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = "com.fututel.codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "com.fututel.plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = "com.fututel.db";
    /**
